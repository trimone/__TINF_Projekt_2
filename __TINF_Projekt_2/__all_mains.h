...
//#include "_Main_count.h"
//
// _Main_count* _main_obj[100];
// string j = "19_02_12__KA_Uebung_Supermarkt";
// int i;
//void test(string main_name)
//{
//	int i = _Main_count::get_main_count();
//	_main_obj[i] = new _Main_count;
//	_main_obj[i-1]->inc_count();
//	_main_obj[i-1]->set_main_name(main_name);
//}
//
//void _19_02_12__KA_Uebung_Supermarkt(); 
//
